...
//           Free Forver . Upgrade for the nlimited tasks, better security , and exclusive features.
//         </p>
...
//                       <span className="bg-[linear-gradient(to_right,#DD7DDF,#E1CD86,#BBCB92,#71C2EF,#3BFFFF,#DD7DDF)] text-transparent bg-clip-text font-medium"> Popular
        ...
        <div className="flex flex-col gap-6 items-center lg:flex-row lg:items-end lg:justify-center">
          {pricingTiers.map(
            (
              ...
              <div
                key={title} // or use `key={tierIndex}` if titles aren't guaranteed unique
